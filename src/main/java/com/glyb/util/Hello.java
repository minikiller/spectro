...
public class Hello {
    ...
    private static void My_Del_Nois2(Double[] sign_in, Long[] L, String wname, Integer DIME, Double[] ca) {
        ...
        C =new Double[M];
        CopyArrDbl2(C, sign_in, 1, M * 8);

        Fun.My_Getfilters(wname, lp_d, hp_d, lp_r, hp_r);                           //   '提取四种滤波器
        ...
        for (int kkk = 1; kkk < DIME; kkk++) {
            ...
            if (kkk == 1) {
                ...
                dnh=new Double[length_dnh.intValue()];
                 ...
                 CopyArr(dnl, C, length_dnl * 8, 1, (length_sign_in - length_dnl - length_dnh) + 1);


                 CopyArr(dnh, C, length_dnh * 8, 1, (length_sign_in - length_dnh) + 1);
